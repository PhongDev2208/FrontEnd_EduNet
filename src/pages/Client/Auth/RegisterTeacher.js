...
function RegisterStudent() {
  ...
  const handle_Submit_form_login = async (e) => {
    ...
    const hasemtry = Object.values(data).some(
                        ...
                        children: (
                          <div>
                            ...
                            <div method="POST">
                              ...
                              >
                                <div
                                  className="fxt-form-row"
                                  style={{ textAlign: "center" }}
                                >
                                  Vui lòng bật thông báo email email chúng tôi
                                  sẽ liên hệ với bạn trong vòng 1 tuần
                                </div>
                              </div>
                            </div>
                          </div>
                    ...
                    >
                      {active > 1 && active < 4 && (
                        <div
                          ...
                          onClick={() => handle_step_form_register(1)}
                          className="fxt-btn-fill mr-2"
                        >
                          Previous
                        </div>
                      )}
                      ...
                      {active === 3 ? (
                        ...
                        active < 3 && (
                          <div
                            onClick={() => handle_step_form_register(2)}
                            style={{
                              textAlign: "center",
                              borderRadius: "0px",
                              marginLeft: "5px",
              ...
              <div className="fxt-footer">
                <div className="fxt-transformY-50 fxt-transition-delay-9">
                  <p>
                    ...
                    <Link
                      to="/auth/login"
                      className="switcher-text2 inlinew-text"
                    >
                      Login
                    </Link>
                  </p>
