...
function Detail() {
  ...
  const items = [
      ...
      children: (
        <div className="tab-pane slide slide show active" id="tab1">
          <div className="content pb-20">
            {DataDetailCourse != null && (
              <div
                dangerouslySetInnerHTML={{
                  __html: DataDetailCourse.description,
                }}
              />
            )}
          </div>
    ...
    },
    {
      ...
      children: (
        <div className="tab-pane slide phicss_collapse_detailcourse" id="tab2">
      ...
      children: (
        <div className="tab-pane" id="tab3">
          <div className="content pb-20">
            {DataDetailCourse != null && (
              <div
                dangerouslySetInnerHTML={{ __html: DataDetailCourse.goal }}
              />
            )}
          </div>
        </div>
          ...
          <div className="review-progresses p-30 radius-md border mb-40">
            <div className="d-flex flex-wrap align-items-center justify-content-between gap-3 mb-30">
              ...
              <div className="ratings size-md">
                <div
                  className="rate bg-img"
                  data-bg-image="assets/images/rate-star-md.png"
                >
                  <div
                    className="rating-icon bg-img"
                    data-bg-image="assets/images/rate-star-md.png"
                  />
                </div>
            ...
            <div className="review-progress mb-10 row align-items-center">
              ...
              <div className="progress-line col-6 col-sm-8">
                <div className="progress">
                  <div
                    className="progress-bar background-all bg-primary"
                    style={{ width: "90%" }}
                    role="progressbar"
                ...
                return (
                  <div className="review-list mb-30 border radius-md">
                    <div className="review-item p-30">
                      <div className="review-header flex-wrap mb-20">
                        <div className="author d-flex align-items-center justify-content-between gap-3">
                          <div className="author-info">
                            ...
                            <div className="ratings mb-1">
                              <div
                                className="rate bg-img color-all"
                                style={{
                                  fontSize: "10px",
                                  width: "100%",
                                  marginLeft: "3px",
                                ...
                                data-bg-image="assets/images/rate-star.png"
                              >
                                {[...Array(item.rate)].map((_, index) => {
                                  // Thay "item" bằng "_" để tránh xung đột
                                  return (
                                    <FontAwesomeIcon
                            ...
                            <span className="font-xsm icon-start color-all">
                              <FontAwesomeIcon
                                style={{ color: "#30C2EC", marginRight: "4px" }}
                                icon={faUser}
                              />{" "}
                              {item.role == "tea" ? "Teacher" : "Student"}
                            </span>
                          </div>
                        </div>
                        <div className="more-info font-sm">
                      ...
                      <p className="color-gray">{item.content}</p>
                      ...
                      <ul className="d-flex  detail-image-review">
                        {item.images.length > 0 &&
                          item.images.map((item_image) => {
                            return (
                              <li>
                                <Image width={200} src={item_image} />
                              </li>
                            );
                          })}
                      </ul>
          ...
          >
            ...
            >
              ...
              <div style={{ textAlign: "right", marginTop: "-100px" }}>
                <Button
                  className="background-color-All"
                  type="primary"
                  htmlType="submit"
                >
                  Submit
  ...
  if (DataDetailCourse != null) {
    formattedPrice =
      new Intl.NumberFormat("vi-VN").format(DataDetailCourse.price) + " VNĐ";
  }
  return (
    DataDetailCourse != null && (
          ...
          <div className="row gx-xl-5">
              ...
              <div className="course-details-tab pt-5">
                <div className="tab-content phisstab_detail_course">
                  <Tabs
                    defaultActiveKey="1"
                    items={items}
                    onChange={handle_tabs_course_Detail}
                  />
                </div>
              </div>
            </div>
            <div className="col-lg-4" data-aos="fade-up">
              <aside className="widget-area bg-white shadow-md radius-md">
                <div
                  className="widget widget-enroll p-25"
                  style={{
                ...
                >
                  <figure className="course-img">
                    <img
                      className="lazyload"
                      src={DataDetailCourse.img[0]}
                      data-src="assets/images/course/pro-13.jpg"
                      alt="course"
                    />
                  </figure>
                  <div
                    className="course-price mt-15"
                    style={{ textAlign: "center" }}
                  >
                    <h4
                      className="color-all new-price"
                      style={{ fontSize: "22px" }}
                    >
                      {DataDetailCourse.price.toLocaleString("vi-VN")} VNĐ{" "}
                    </h4>
                    <h4
                      className="color-gray new-price prev-price"
                      style={{ fontSize: "20px" }}
                    >
                      4.000.000 VNĐ
                    </h4>
                  ...
                  <div className="btn-groups mt-15">
                    <button
                      href="cart.html"
                      className="background-color-All btn btn-lg btn-primary radius-sm w-100"
                      title="Add to Cart"
                      onClick={() => handle_register_course_detail(id)}
                      target="_self"
                    >
                      Register
                    </button>
                  ...
                  <ul
                    className="toggle-list list-unstyled mt-20"
                    id="toggleList"
                    data-toggle-show={5}
                  >
                    <li className="icon-start">
                      ...
                      >
                        {DataDetailCourse.time.start_display}
                      </span>
                    </li>
                    <li className="icon-start">
                      <span>
