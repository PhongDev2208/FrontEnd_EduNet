...
function ClassRoom() {
          ...
          Status:
            ...
            (item.status == 1 ? (
              <Button
                ...
                onClick={() => handle_status_mycourse(item._id)}
              >
                Not reviewed
              </Button>
            ) : (
              <Button onClick={() => handle_status_mycourse(item._id)}>
                Reviewed
              </Button>
            )),
        };
  ...
  return Data_Mycourse_Student != null ? (
    <div className="shopping-area pt-100 pb-60">
      <div className="container">
        <Card
          title="List of course Student"
    ...
    <div className="shopping-area pt-100 pb-60">
      <div className="container">Không có học sinh trong khóa học</div>
    </div>
  );
}
